...
print "Principal Componenets Analysis : Components 100"
pca_output = PCA(n_components=100).fit(datal)
dataset_pca_out=pca_output.transform(datal)

print "*****SVM with RBF Kernels*********"
clf_op=svm.SVC(kernel='rbf')

count = 1
print
print "------Fold No------", count
clf_op.fit(dataset_pca_out[:80],labels[:80])#Teseting
...
print
print "------Fold No------", count
clf_op.fit(dataset_pca_out[20:100],labels[20:100])#Teseting
...
print
print "------Fold No------", count
clf_op.fit(dataset_pca_out[10:90],labels[10:90])#Teseting
...
print
print "------Fold No------", count
clf_op.fit(dataset_pca_out[20:100],labels[20:])#Teseting
